...
import { User, Envelope, Buildings, Phone, ChatCircle, Drone, Sparkle, Lightning, Target, CheckCircle, ArrowRight, Star } from '@phosphor-icons/react';
...
const InterestForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await dbService.createInterestForm(submissionData);
      console.log('Interest form saved:', result);
    ...
    <section id="contact" className="py-24 bg-gradient-to-br from-neutral-50 via-white to-neutral-100 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-end">
          ...
          <div className="animate-slide-up space-y-8">
            ...
            <div className="relative">
              <div className="absolute inset-0 rounded-3xl overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-br from-white/95 to-neutral-50/95"></div>
              </div>
              <div className="relative bg-gradient-to-br from-white/80 to-neutral-50/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-neutral-200/50 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-primary-700 to-primary-600 rounded-3xl p-8 text-white relative overflow-hidden shadow-2xl border border-primary-600/50">
              {/* Background decorative elements */}
          ...
          {/* Right Column: Contains both images and form */}
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <img
                ...
                className="rounded-xl shadow-lg w-full h-24 object-cover hover:scale-105 transition-transform duration-300"
              />
              <img
                src="https://images.pexels.com/photos/590016/pexels-photo-590016.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&fit=crop"
                alt="Real-time inspection monitoring"
                className="rounded-xl shadow-lg w-full h-24 object-cover hover:scale-105 transition-transform duration-300"
              />
            </div>
